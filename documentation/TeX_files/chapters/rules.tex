...
\begin{itemize}
    ...
    \begin{itemize}
        \item A Magic card effect can be used immediately after the card is played.
        \item Magic card effects can be activated at any point during either players turn once the card is on the field.
    \end{itemize}
    \item \textbf{Creature Cards:}
    \begin{itemize}
        \item A creature card effect can be used immediately after the card is played.
        \item Creature effects can only be activated on the owning players turn.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Magic Cards:}
    \begin{itemize}
        \item When a magic card effect is activated (even if it's is a continuous effect), that card is tapped.
    \end{itemize}
...
\begin{itemize}
    ...
    \item During an attack, whichever creature has the higher power/attack prevails, and the other is destroyed (unless a card states otherwise) and sent to the discard pile.
\end{itemize}
