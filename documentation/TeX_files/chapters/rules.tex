...
\begin{description}
	...
	\item[PROMOTE:] The act of placing a card of one level higher on top of another card.
    \item[UNDER:] Refers to all cards that are beneath another card (usually through leveling up cards).
    \item[DESTROY:] The act of sending a card to the discard pile.
    ...
    \item[TYPE:] One of the primary types of cards within the game - Water, Fire, Earth, Air, Nature, Electric, Light, Dark.
    \item[SUBTYPE:] One of the subtype categories of cards within the game - Dragon, Warrior, Beast, Spell-caster, Flying, Insect, Reptile, Humanoid, Machine, Fairy, Ghost, Fish, etc.
    \item[LEVEL:] The number of stars on a card.
